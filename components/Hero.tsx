...
export function Hero() {
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 pb-24 pt-28">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom,_rgba(74,111,173,0.18),_transparent_55%)]" />
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center text-center text-white">
        ...
        >
          <button className="rounded-full bg-white px-8 py-3 text-sm font-semibold uppercase tracking-[0.35em] text-neutral-950 transition hover:-translate-y-0.5 hover:shadow-[0_15px_40px_rgba(255,255,255,0.2)]">
            Enter
          </button>
